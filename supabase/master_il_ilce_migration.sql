-- ============================================================
-- TÜRKİYE İL VE İLÇE MASTER VERİ SETİ
-- ============================================================

-- 1. İLLER TABLOSU VE VERİLERİ
...
CREATE TABLE IF NOT EXISTS ilceler (
  id INTEGER PRIMARY KEY,
  il_id INTEGER REFERENCES iller(id) ON DELETE CASCADE,
  ad TEXT NOT NULL,
  UNIQUE(il_id, ad)
);
...
ALTER TABLE okullar ADD COLUMN IF NOT EXISTS ilce_id INTEGER REFERENCES ilceler(id);
ALTER TABLE profiller ADD COLUMN IF NOT EXISTS il_id INTEGER REFERENCES iller(id);
ALTER TABLE profiller ADD COLUMN IF NOT EXISTS ilce_id INTEGER REFERENCES ilceler(id);
...
CREATE POLICY "iller_oku" ON iller FOR SELECT USING (true);

DROP POLICY IF EXISTS "ilceler_oku" ON ilceler;
CREATE POLICY "ilceler_oku" ON ilceler FOR SELECT USING (true);
...
INSERT INTO ilceler (id, il_id, ad) VALUES
(1757, 1, 'ALADAĞ'),
(1219, 1, 'CEYHAN'),
(2033, 1, 'ÇUKUROVA'),
(1329, 1, 'FEKE'),
