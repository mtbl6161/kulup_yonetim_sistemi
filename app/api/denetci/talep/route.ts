...
export async function GET(request: NextRequest) {
  ...
  // Kullanıcının profilinden okul_id al
...
export async function POST(request: NextRequest) {
  ...
  // Kullanıcı profilinden okul_id ve il_id al
  const { data: profil } = await supabase
    .from('profiller')
  ...
  // il_id öncelik sırası: formdan gelen → profil → okullar tablosu
  ...
  // Bu ilde zaten bekleyen talep var mı?
